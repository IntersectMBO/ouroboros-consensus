...
instance SameDepIndex2 (BlockQuery (LegacyBlock (ShelleyBlock proto era))) where
  ...
  sameDepIndex2 (LegacyBlockQuery (GetStakeDelegDeposits _)) _
    = Nothing
  sameDepIndex2 (LegacyBlockQuery GetConstitution) (LegacyBlockQuery GetConstitution)
    = Just Refl
  sameDepIndex2 (LegacyBlockQuery GetConstitution) _
    = Nothing
  sameDepIndex2 (LegacyBlockQuery GetGovState) (LegacyBlockQuery GetGovState)
    = Just Refl
  sameDepIndex2 (LegacyBlockQuery GetGovState) _
    = Nothing
  sameDepIndex2 (LegacyBlockQuery GetDRepState{}) (LegacyBlockQuery GetDRepState{})
    = Just Refl
  sameDepIndex2 (LegacyBlockQuery GetDRepState{}) _
    = Nothing
  sameDepIndex2 (LegacyBlockQuery GetDRepStakeDistr{}) (LegacyBlockQuery GetDRepStakeDistr{})
    = Just Refl
  sameDepIndex2 (LegacyBlockQuery GetDRepStakeDistr{}) _
    = Nothing
  sameDepIndex2 (LegacyBlockQuery GetCommitteeState) (LegacyBlockQuery GetCommitteeState)
    = Just Refl
  sameDepIndex2 (LegacyBlockQuery GetCommitteeState) _
    = Nothing
