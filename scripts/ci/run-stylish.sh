...
fd -p $(pwd)/ouroboros-consensus \
    ...
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/API.hs \
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/API/Types.hs \
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/CRC.hs \
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/Handle.hs \
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/IO.hs \
    -E ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/IO.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/Classify.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/Error.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/FsTree.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/MockFS.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/Pure.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/STM.hs \
    -E ouroboros-consensus/src/consensus-testlib/Test/Util/Blob.hs \
...
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/API.hs            >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/API/Types.hs      >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/CRC.hs            >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/Handle.hs         >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/FS/IO.hs             >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/ouroboros-consensus/Ouroboros/Consensus/Storage/IO.hs                >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/Classify.hs                       >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/Error.hs                   >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/FsTree.hs                  >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/MockFS.hs                  >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/Pure.hs                    >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/FS/Sim/STM.hs                     >/dev/null 2>&1
grep "module.*DEPRECATED" ouroboros-consensus/src/consensus-testlib/Test/Util/Blob.hs                           >/dev/null 2>&1
