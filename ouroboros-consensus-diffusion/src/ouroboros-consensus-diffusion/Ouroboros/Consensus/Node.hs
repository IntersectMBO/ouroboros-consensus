...
data LowLevelRunNodeArgs m addrNTN addrNTC blk
  ...
  -- ^ Ie 'keepAliveRng'
  , llrnPeerSelectionRng :: StdGen
  -- ^ stdgen used diffusion's peer selection policy
...
data
  ...
  , srnDiffusionConfiguration :: Cardano.Diffusion.CardanoConfiguration
  , srnDiffusionTracers       :: Cardano.Diffusion.CardanoTracers
      ...
      handleJust
        ...
        $ do
          ...
          continueWithCleanChainDB chainDB $ do
            ...
            let consensusDiffusionArgs = Cardano.Diffusion.CardanoConsensusArguments {
            ...
            stdGen <- StrictSTM.newTVarIO llrnPeerSelectionRng
     ...
     where
      apps =
        Diffusion.Applications
          ...
          , Diffusion.daRepromoteDelay      = Diffusion.repromoteDelay
          , Diffusion.daLocalRethrowPolicy  = localRethrowPolicy
          , daPeerSelectionPolicy           = Cardano.Diffusion.simpleChurnModePeerSelectionPolicy
                                                stdGenVar
...
stdPeerSelectionPolicy :: IO StdGen
stdPeerSelectionPolicy = newStdGen
...
stdRunDataDiffusion ::
  ...
  Cardano.Diffusion.CardanoTracers ->
  Cardano.Diffusion.CardanoConfiguration ->
  Cardano.Diffusion.CardanoApplications a ->
  IO ()
...
stdLowLevelRunNodeArgsIO
  ...
  $(SafeWildCards.fields 'StdRunNodeArgs) = do
    ...
    llrnPeerSelectionRng <- stdPeerSelectionPolicy
    pure
      LowLevelRunNodeArgs
        { llrnBfcSalt
