...
data ByteLimits addr bCS bBF bTX bKA bPS = ByteLimits
  { blChainSync ::
...
noByteLimits :: ByteLimits addr bCS bBF bTX bKA bPS
noByteLimits =
  ByteLimits
...
byteLimits :: ByteLimits addr ByteString ByteString ByteString ByteString ByteString
byteLimits =
  ByteLimits
...
mkApps ::
  ...
  ByteLimits addrNTN bCS bBF bTX bKA bPS ->
