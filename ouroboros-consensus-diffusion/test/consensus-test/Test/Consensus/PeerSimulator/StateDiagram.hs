...
initBranch ::
  ...
  BlockTree blk -> Int -> Range -> AF.AnchoredFragment blk -> BranchSlots blk
...
addFragRange ::
  (Eq (Header blk), AF.HasHeader (Header blk)) =>
  Aspect -> AF.AnchoredFragment (Header blk) -> TreeSlots blk -> TreeSlots blk
...
addCandidateRange ::
  (Eq (Header blk), AF.HasHeader (Header blk)) =>
  TreeSlots blk -> (PeerId, AF.AnchoredFragment (Header blk)) -> TreeSlots blk
...
addTipPoint ::
  forall blk.
  AF.HasHeader blk => BlockTree blk -> PeerId -> WithOrigin blk -> TreeSlots blk -> TreeSlots blk
