  ...
  chainSyncClient
    CSClient.ConfigEnv {
      ...
      , CSClient.someHeaderInFutureCheck = dummyHeaderInFutureCheck
        -- Preventing historical MsgRollBacks and MsgAwaitReplies is motivated
        -- by preventing additional load from CSJ-disengaged peers; we do not
        -- care about this in these tests.
