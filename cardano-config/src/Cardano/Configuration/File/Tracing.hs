...
data TraceSelection
  = TraceSelection
  { traceVerbosity :: Maybe TracingVerbosity
  , -- Per-trace toggles, alpha-sorted.
    traceAcceptPolicy :: Maybe (OnOff TraceAcceptPolicy)
  , traceBackingStore :: Maybe (OnOff TraceBackingStore)
  , traceBlockFetchClient :: Maybe (OnOff TraceBlockFetchClient)
  , traceBlockFetchDecisions :: Maybe (OnOff TraceBlockFetchDecisions)
  , traceBlockFetchProtocol :: Maybe (OnOff TraceBlockFetchProtocol)
  , traceBlockFetchProtocolSerialised :: Maybe (OnOff TraceBlockFetchProtocolSerialised)
  , traceBlockFetchServer :: Maybe (OnOff TraceBlockFetchServer)
  , traceBlockchainTime :: Maybe (OnOff TraceBlockchainTime)
  , traceChainDB :: Maybe (OnOff TraceChainDB)
  , traceChainSyncBlockServer :: Maybe (OnOff TraceChainSyncBlockServer)
  , traceChainSyncClient :: Maybe (OnOff TraceChainSyncClient)
  , traceChainSyncHeaderServer :: Maybe (OnOff TraceChainSyncHeaderServer)
  , traceChainSyncProtocol :: Maybe (OnOff TraceChainSyncProtocol)
  , traceChurnMode :: Maybe (OnOff TraceChurnMode)
  , traceConnectionManager :: Maybe (OnOff TraceConnectionManager)
  , traceConnectionManagerCounters :: Maybe (OnOff TraceConnectionManagerCounters)
  , traceConnectionManagerTransitions :: Maybe (OnOff TraceConnectionManagerTransitions)
  , traceCsj :: Maybe (OnOff TraceCsj)
  , traceDNS :: Maybe (OnOff TraceDNS)
  , traceDebugPeerSelectionInitiatorResponderTracer ::
      Maybe (OnOff DebugPeerSelectionInitiatorResponder)
  , traceDebugPeerSelectionInitiatorTracer :: Maybe (OnOff DebugPeerSelectionInitiator)
  , traceDevotedBlockFetch :: Maybe (OnOff TraceDevotedBlockFetch)
  , traceDiffusionInitialization :: Maybe (OnOff TraceDiffusionInitialization)
  , traceDnsResolver :: Maybe (OnOff TraceDnsResolver)
  , traceDnsSubscription :: Maybe (OnOff TraceDnsSubscription)
  , traceErrorPolicy :: Maybe (OnOff TraceErrorPolicy)
  , traceForge :: Maybe (OnOff TraceForge)
  , traceForgeStateInfo :: Maybe (OnOff TraceForgeStateInfo)
  , traceGDD :: Maybe (OnOff TraceGDD)
  , traceGsm :: Maybe (OnOff TraceGsm)
  , traceHandshake :: Maybe (OnOff TraceHandshake)
  , traceInboundGovernor :: Maybe (OnOff TraceInboundGovernor)
  , traceInboundGovernorCounters :: Maybe (OnOff TraceInboundGovernorCounters)
  , traceInboundGovernorTransitions :: Maybe (OnOff TraceInboundGovernorTransitions)
  , traceIpSubscription :: Maybe (OnOff TraceIpSubscription)
  , traceKeepAliveClient :: Maybe (OnOff TraceKeepAliveClient)
  , traceKeepAliveProtocol :: Maybe (OnOff TraceKeepAliveProtocol)
  , traceKesAgent :: Maybe (OnOff TraceKesAgent)
  , traceLedgerPeers :: Maybe (OnOff TraceLedgerPeers)
  , traceLocalChainSyncProtocol :: Maybe (OnOff TraceLocalChainSyncProtocol)
  , traceLocalConnectionManager :: Maybe (OnOff TraceLocalConnectionManager)
  , traceLocalErrorPolicy :: Maybe (OnOff TraceLocalErrorPolicy)
  , traceLocalHandshake :: Maybe (OnOff TraceLocalHandshake)
  , traceLocalInboundGovernor :: Maybe (OnOff TraceLocalInboundGovernor)
  , traceLocalMux :: Maybe (OnOff TraceLocalMux)
  , traceLocalMuxBearer :: Maybe (OnOff TraceLocalMuxBearer)
  , traceLocalMuxChannel :: Maybe (OnOff TraceLocalMuxChannel)
  , traceLocalRootPeers :: Maybe (OnOff TraceLocalRootPeers)
  , traceLocalServer :: Maybe (OnOff TraceLocalServer)
  , traceLocalStateQueryProtocol :: Maybe (OnOff TraceLocalStateQueryProtocol)
  , traceLocalTxMonitorProtocol :: Maybe (OnOff TraceLocalTxMonitorProtocol)
  , traceLocalTxSubmissionProtocol :: Maybe (OnOff TraceLocalTxSubmissionProtocol)
  , traceLocalTxSubmissionServer :: Maybe (OnOff TraceLocalTxSubmissionServer)
  , traceMempool :: Maybe (OnOff TraceMempool)
  , traceMux :: Maybe (OnOff TraceMux)
  , traceMuxBearer :: Maybe (OnOff TraceMuxBearer)
  , traceMuxChannel :: Maybe (OnOff TraceMuxChannel)
  , tracePeerSelection :: Maybe (OnOff TracePeerSelection)
  , tracePeerSelectionActions :: Maybe (OnOff TracePeerSelectionActions)
  , tracePeerSelectionCounters :: Maybe (OnOff TracePeerSelectionCounters)
  , tracePeerSharingProtocol :: Maybe (OnOff TracePeerSharingProtocol)
  , tracePublicRootPeers :: Maybe (OnOff TracePublicRootPeers)
  , traceSanityCheckIssue :: Maybe (OnOff TraceSanityCheckIssue)
  , traceServer :: Maybe (OnOff TraceServer)
  , traceTxInbound :: Maybe (OnOff TraceTxInbound)
  , traceTxOutbound :: Maybe (OnOff TraceTxOutbound)
  , traceTxSubmission2Protocol :: Maybe (OnOff TraceTxSubmission2Protocol)
  , traceTxSubmissionProtocol :: Maybe (OnOff TraceTxSubmissionProtocol)
  }
  deriving (Eq, Show)
...
parseTracer :: KnownSymbol name => Proxy name -> Object -> Parser (Maybe (OnOff name))
