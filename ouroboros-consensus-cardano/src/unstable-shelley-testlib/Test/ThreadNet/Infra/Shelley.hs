...
import Cardano.Crypto.Seed qualified as Cardano.Crypto
...
import Cardano.Ledger.Allegra.Scripts qualified as SL
...
import Cardano.Ledger.Mary.Core qualified as SL
import Cardano.Ledger.Shelley.API qualified as SL
import Cardano.Ledger.Val qualified as SL
...
import Test.Cardano.Ledger.Shelley.Generator.Core qualified as Gen
...
mkKeyHashVrf ::
  forall c r. Crypto c => SignKeyVRF (VRF c) -> LK.VRFVerKeyHash (r :: LK.KeyRoleVRF)
