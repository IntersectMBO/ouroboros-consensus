...
data instance BlockQuery (ShelleyBlock proto era) fp result where
  ...
  GetStakeDistribution
    :: BlockQuery (ShelleyBlock proto era) QFNoTables (PoolDistr (EraCrypto era))
  ...
  GetCommitteeMembersState
    ...
    -> Set SL.MemberStatus
    -> BlockQuery (ShelleyBlock proto era) QFNoTables (SL.CommitteeMembersState (EraCrypto era))
  ...
  GetSPOStakeDistr
    ...
    -> BlockQuery (ShelleyBlock proto era) QFNoTables (Map (KeyHash 'StakePool (EraCrypto era)) Coin)
