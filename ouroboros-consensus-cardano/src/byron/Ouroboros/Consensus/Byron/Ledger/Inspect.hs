...
import Cardano.Chain.Common qualified as CC
import Cardano.Chain.Genesis qualified as CC.Genesis
import Cardano.Chain.ProtocolConstants qualified as CC
import Cardano.Chain.Slotting qualified as CC
import Cardano.Chain.Update qualified as U
import Cardano.Chain.Update.Validation.Endorsement qualified as U.E
import Cardano.Chain.Update.Validation.Interface qualified as U.I
import Cardano.Chain.Update.Validation.Registration qualified as U.R
...
import Ouroboros.Consensus.HardFork.History.Util qualified as History
 ...
 where
  ...
  endorsements =
    Map.fromListWith Set.union
      . map
        ( \e ->
            ( U.E.endorsementProtocolVersion e
