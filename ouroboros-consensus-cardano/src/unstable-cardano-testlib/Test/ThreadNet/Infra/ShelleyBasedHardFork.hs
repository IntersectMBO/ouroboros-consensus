...
instance TranslateTxMeasure ByteSize ByteSize where
  translateTxMeasure = id

instance TranslateTxMeasure ByteSize AlonzoMeasure where
  translateTxMeasure x = AlonzoMeasure x mempty

instance TranslateTxMeasure ByteSize ConwayMeasure where
  translateTxMeasure =
