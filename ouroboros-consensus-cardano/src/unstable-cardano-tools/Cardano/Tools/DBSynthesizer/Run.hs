...
--
-- Reading files is not this function's business: @cardano-config@ parses and
-- resolves the configuration and loads every era's genesis, and
-- "Cardano.Tools.Credentials" reads the credentials through @cardano-keys@.
