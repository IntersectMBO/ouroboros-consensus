...
-- bidirectional.
type CardanoLedgerState m c = LedgerState m (CardanoBlock c)

pattern LedgerStateByron ::
  LedgerState m ByronBlock ->
  CardanoLedgerState m c
...
pattern LedgerStateShelley ::
  LedgerState m (ShelleyBlock (TPraos c) ShelleyEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateAllegra ::
  LedgerState m (ShelleyBlock (TPraos c) AllegraEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateMary ::
  LedgerState m (ShelleyBlock (TPraos c) MaryEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateAlonzo ::
  LedgerState m (ShelleyBlock (TPraos c) AlonzoEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateBabbage ::
  LedgerState m (ShelleyBlock (Praos c) BabbageEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateConway ::
  LedgerState m (ShelleyBlock (Praos c) ConwayEra) ->
  CardanoLedgerState m c
...
pattern LedgerStateDijkstra ::
  LedgerState m (ShelleyBlock (Praos c) DijkstraEra) ->
  CardanoLedgerState m c
