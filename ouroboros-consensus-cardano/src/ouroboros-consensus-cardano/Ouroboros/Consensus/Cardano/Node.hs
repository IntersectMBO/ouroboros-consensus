...
import Cardano.Protocol.TPraos.OCert qualified as Absolute
  ( KESPeriod (..)
  , ocertKESPeriod
  )
...
import Data.SOP.OptNP qualified as OptNP
...
import Ouroboros.Consensus.Byron.Ledger.Conversions qualified as Byron
...
import Ouroboros.Consensus.Protocol.TPraos qualified as Shelley
...
import Ouroboros.Consensus.Shelley.Node.Praos qualified as Praos
import Ouroboros.Consensus.Shelley.Node.TPraos qualified as TPraos
