...
instance CardanoHardForkConstraints c
  ...
  supportedNodeToClientVersions _ = Map.fromList $
      ...
      , (NodeToClientV_16, CardanoNodeToClientVersion13) -- FIXME: here we need a new NodeToClientV_16 provided by network
      ]

  latestReleasedNodeVersion _prx = (Just NodeToNodeV_13, Just NodeToClientV_16) -- FIXME: here we need a new NodeToClientV_16 provided by network
