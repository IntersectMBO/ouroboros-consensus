...
translateLedgerTablesShelleyToAllegraWrapper ::
  TranslateLedgerTables
    ...
    (ShelleyBlock (TPraos c) AllegraEra)
translateLedgerTablesShelleyToAllegraWrapper =
  TranslateLedgerTables (TranslateTable SL.upgradeTxOut SOP.:* SOP.Nil)
