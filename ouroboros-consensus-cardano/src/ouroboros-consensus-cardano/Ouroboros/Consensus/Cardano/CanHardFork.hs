...
import Cardano.Ledger.Core qualified as SL
import Cardano.Ledger.Genesis qualified as SL
import Cardano.Ledger.Shelley.API qualified as SL
import Cardano.Ledger.Shelley.Translation
  ( toFromByronTranslationContext
  )
import Cardano.Protocol.TPraos.API qualified as SL
import Cardano.Protocol.TPraos.Rules.Prtcl qualified as SL
import Cardano.Protocol.TPraos.Rules.Tickn qualified as SL
...
import Data.SOP.Strict qualified as SOP
import Data.SOP.Tails (Tails (..))
import Data.SOP.Tails qualified as Tails
import Data.Void
