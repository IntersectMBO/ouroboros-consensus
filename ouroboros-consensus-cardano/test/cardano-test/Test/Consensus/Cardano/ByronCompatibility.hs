...
newtype instance BlockQuery ByronToCardano fp a = QueryB2C   { unQueryB2C   :: BlockQuery ByronBlock fp a } deriving (Eq, Show)
...
instance ShowQuery (BlockQuery ByronToCardano fp) where
  showResult (QueryB2C query) = showResult query

instance SameDepIndex2 (BlockQuery ByronToCardano) where
  sameDepIndex2 (QueryB2C q1) (QueryB2C q2) = sameDepIndex2 q1 q2
...
instance SerialiseNodeToClient ByronToCardano (SomeBlockQuery (BlockQuery ByronToCardano)) where
  encodeNodeToClient = encodeNodeToClientB2C
                         (Proxy @(SomeBlockQuery :.: BlockQuery))
                         (\(SomeBlockQuery q) -> SomeBlockQuery (unQueryB2C q))
...
instance Arbitrary (SomeBlockQuery (BlockQuery ByronToCardano)) where
  arbitrary = (\(SomeBlockQuery q) -> SomeBlockQuery (QueryB2C q)) <$> arbitrary
...
newtype instance BlockQuery CardanoToByron fp a = QueryC2B   { unQueryC2B   :: BlockQuery ByronBlock fp a } deriving (Eq, Show)
...
instance ShowQuery (BlockQuery CardanoToByron fp) where
  showResult (QueryC2B query) = showResult query

instance SameDepIndex2 (BlockQuery CardanoToByron) where
  sameDepIndex2 (QueryC2B q1) (QueryC2B q2) = sameDepIndex2 q1 q2
...
instance SerialiseNodeToClient CardanoToByron (SomeBlockQuery (BlockQuery CardanoToByron)) where
  encodeNodeToClient =
      encodeNodeToClientC2B
        (Proxy @(SomeBlockQuery :.: BlockQuery))
        (\(SomeBlockQuery q) -> SomeBlockQuery (QueryIfCurrentByron (unQueryC2B q)))
  decodeNodeToClient =
      decodeNodeToClientC2B
        (Proxy @(SomeBlockQuery :.: BlockQuery))
...
instance Arbitrary (SomeBlockQuery (BlockQuery CardanoToByron)) where
  arbitrary = (\(SomeBlockQuery q) -> SomeBlockQuery (QueryC2B q)) <$> arbitrary
