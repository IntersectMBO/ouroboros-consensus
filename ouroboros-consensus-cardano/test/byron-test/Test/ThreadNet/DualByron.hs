...
import Cardano.Chain.ProtocolConstants qualified as Impl
import Cardano.Chain.UTxO qualified as Impl
import Cardano.Ledger.BaseTypes (nonZeroOr)
import Control.Monad.Except
import Control.State.Transition.Extended qualified as Spec
...
import Ouroboros.Consensus.ByronSpec.Ledger.Rules qualified as Rules
...
import Test.Cardano.Chain.Elaboration.UTxO qualified as Spec.Test
import Test.Control.State.Transition.Generator qualified as Spec.QC
import Test.QuickCheck
import Test.QuickCheck.Hedgehog (hedgehog)
import Test.Tasty
import Test.Tasty.QuickCheck
import Test.ThreadNet.Byron qualified as Byron
...
genSpecGenesis slotLen (NumSlots numSlots) =
  fmap fromEnv . hedgehog $
