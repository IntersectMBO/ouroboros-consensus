...
tests = testGroup "Mempool fairness"
                  [ testCase "There is no substantial bias in added transaction sizes" $
                              testTxSizeFairness TestParams { mempoolMaxCapacity = ByteSize 100
                                                            , smallTxSize        = ByteSize   1
                                                            , largeTxSize        = ByteSize  10
...
data TestParams = TestParams {
    mempoolMaxCapacity :: ByteSize
  , smallTxSize        :: ByteSize
    -- ^ Size of what we consider to be a small transaction.
  , largeTxSize        :: ByteSize
