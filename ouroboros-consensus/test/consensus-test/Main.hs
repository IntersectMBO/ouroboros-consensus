...
import qualified Test.Consensus.Peras.Cert.V1 (tests)
...
tests =
  testGroup
    ...
    , Test.Consensus.MiniProtocol.ObjectDiffusion.PerasVote.Smoke.tests
    ...
    , testGroup
        ...
        , Test.Consensus.Peras.Cert.V1.tests
