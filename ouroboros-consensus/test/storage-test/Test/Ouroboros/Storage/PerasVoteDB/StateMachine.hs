...
instance RunModel Model (StateT (PerasVoteDB IO TestBlock) IO) where
  ...
  postcondition (Model model, _) (AddVote vote) _ actual = do
    ...
    case (expected, actual) of
      (Just expectedRes, Right actualRes) -> do
