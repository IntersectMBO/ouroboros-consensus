...
module Test.Consensus.Storage.TestBlock (
    -- * Test block
    BlockConfig (..)
  , ChainLength (..)
  , CodecConfig (..)
...
import           Test.Consensus.Storage.ChainDB.Model
...
instance ApplyBlock (LedgerState TestBlock) TestBlock where
  applyBlockLedgerResult _ tb@TestBlock{..} (TickedTestLedger TestLedger{lastAppliedHash})
