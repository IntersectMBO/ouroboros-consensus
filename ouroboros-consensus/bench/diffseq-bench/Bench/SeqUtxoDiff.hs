...
--
-- NOTE: this module is a near copy of @Ouroboros.Consensus.Storage.LedgerDB.HD@
-- from
-- https://github.com/input-output-hk/ouroboros-network/tree/d674b8f73643e3515e45d59949ae35ec8ada76f6.
-- Originally, the referenced module was removed in favour of a more performant
-- alternative in "Ouroboros.Consensus.Storage.LedgerDB.DiffSeq", but it has
-- since been revived here because the DiffSeq benchmarks depend on it. Lastly,
-- do not modify this module unless strictly necessary.
module Bench.SeqUtxoDiff (
    -- * Values
    UtxoValues (..)
  , emptyUtxoValues
  , mapUtxoValues
...
{-------------------------------------------------------------------------------
  Serialization aliases (originally from @Ouroboros.Consensus.Util.CBOR.Simple@)
-------------------------------------------------------------------------------}
