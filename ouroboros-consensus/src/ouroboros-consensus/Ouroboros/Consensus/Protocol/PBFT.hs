...
-- instance, and the Peras @AChainDepSupportsPeras@ instances for @PBftState@
...
instance AChainDepSupportsPeras (PBftState c)

instance AChainDepSupportsPeras (Ticked (PBftState c))
