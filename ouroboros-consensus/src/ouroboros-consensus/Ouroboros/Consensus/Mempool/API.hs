...
instance TxMeasurePhase1Metrics (TxMeasure blk) => TxMeasurePhase1Metrics (MempoolMeasure blk) where
...
instance TxMeasurePhase2Metrics (TxMeasure blk) => TxMeasurePhase2Metrics (MempoolMeasure blk) where
