...
makePerasCertPoolWriterFromCertDB systemTime perasCertDB =
  ObjectPoolWriter
    ...
    , opwAddObjects = \certs -> do
        addPerasVotes systemTime (PerasCertDB.addCert perasCertDB) certs
    , opwHasObject = do
...
makePerasCertPoolWriterFromChainDB systemTime chainDB =
  ObjectPoolWriter
    { opwObjectId = getPerasCertRound
    , opwAddObjects = \certs -> do
        addPerasVotes systemTime (ChainDB.addPerasCertAsync chainDB) certs
    , opwHasObject = do
...
addPerasVotes ::
  ...
  [PerasCert blk] ->
  m ()
addPerasVotes systemTime adder votes = do
  validatePerasCerts votes
