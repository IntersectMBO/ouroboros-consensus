...
-- is cleared, and the selection is updated to now include the header at its
-- tip.
--
...
--
--      - In ChainSel, this means that @hdr@ should not be pipelined, as it might
--        turn out to be a trap header.
--
