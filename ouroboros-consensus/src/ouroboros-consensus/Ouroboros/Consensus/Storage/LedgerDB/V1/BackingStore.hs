...
data OpenBackingStore m l where
  OpenBackingStore ::
...
restoreBackingStore ::
  ...
  FsPath ->
  m (LedgerBackingStore m l)
restoreBackingStore backingStoreBackend trcr bss fs st loadPath =
  newBackingStoreInitialiser backingStoreBackend trcr bss fs (InitFromCopy st loadPath)
...
newBackingStore ::
  ...
  m (LedgerBackingStore m l)
newBackingStore backingStoreBackend trcr bss fs st tables =
  newBackingStoreInitialiser backingStoreBackend trcr bss fs (InitFromValues Origin st tables)
...
--   Tracer m FlavorImplSpecificTrace ->
--   Complete BackingStoreArgs m ->
--   (Complete BackingStoreArgs m -> BackingStoreInit
--   SnapshotsFS m ->
--   BackingStoreInitialiser m l
...
data FlavorImplSpecificTraceOnDisk
  = OnDiskBackingStoreInitialise LMDBLimits
