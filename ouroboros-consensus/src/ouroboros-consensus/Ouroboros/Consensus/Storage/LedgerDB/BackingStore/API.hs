...
-- key-value map with the 'LedgerTable's at a specific point on the chain.
--
-- Its intended use is for storing data structures from the
-- 'Ouroboros.Consensus.Ledger.Basics.LedgerState' and update them with
-- 'Data.Map.Diff.Diff's produced by executing the Ledger rules.
--
