...
instance
  (BlockSupportsLedgerHD m blk, LedgerSupportsProtocol blk) =>
...
-- the anchor.
closeLedgerSeq ::
  (Monad m, BlockSupportsLedgerHD m blk, LedgerSupportsProtocol blk) =>
  LedgerSeq m blk -> m ()
...
-- True
tip ::
  (LedgerSupportsProtocol blk, BlockSupportsLedgerHD m blk) =>
