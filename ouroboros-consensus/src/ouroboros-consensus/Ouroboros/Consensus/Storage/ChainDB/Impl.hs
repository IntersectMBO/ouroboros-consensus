  ...
  lift $ do
    ...
    let chainDB =
          API.ChainDB
            ...
            , reconsiderBlockAsync = getEnv1 h ChainSel.reconsiderBlockAsync
            , registerHeaderListener = getEnv1 h ChainSel.registerHeaderListener
