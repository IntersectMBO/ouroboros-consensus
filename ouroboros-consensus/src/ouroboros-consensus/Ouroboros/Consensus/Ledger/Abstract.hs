...
class
  ...
  applyBlockLedgerResultWithValidation ::
    ...
    blk ->
    Values blk ->
    Ticked l blk EmptyMK ->
    Except (LedgerErr l blk) (LedgerResult blk (l blk EmptyMK, BlockDiff blk))
  ...
  reapplyBlockLedgerResult ::
    ...
    Values blk ->
    Ticked l blk EmptyMK ->
    LedgerResult blk (l blk EmptyMK, BlockDiff blk)
...
defaultReapplyBlockLedgerResult ::
  (HasCallStack, ApplyBlock l blk) =>
  (LedgerErr l blk -> LedgerResult blk (l blk EmptyMK, BlockDiff blk)) ->
  ComputeLedgerEvents ->
  LedgerCfg l blk ->
  blk ->
  Values blk ->
...
applyLedgerBlock ::
  ...
  Values blk ->
  Ticked l blk EmptyMK ->
  Except (LedgerErr l blk) (l blk EmptyMK, BlockDiff blk)
...
tickThenApplyLedgerResult ::
  ...
  Values blk ->
  l blk EmptyMK ->
  Except (LedgerErr l blk) (LedgerResult blk (l blk EmptyMK, TickAndBlockDiff blk))
...
tickThenReapplyLedgerResult ::
  ...
  Values blk ->
  l blk EmptyMK ->
  LedgerResult blk (l blk EmptyMK, TickAndBlockDiff blk)
...
tickThenApply ::
  ...
  Values blk ->
  l blk EmptyMK ->
  Except (LedgerErr l blk) (l blk EmptyMK, TickAndBlockDiff blk)
...
tickThenReapply ::
  ...
  Values blk ->
  l blk EmptyMK ->
  (l blk EmptyMK, TickAndBlockDiff blk)
...
foldLedger ::
  ...
  LedgerCfg l blk ->
  [blk] ->
  (l blk EmptyMK, Values blk) ->
  Except (LedgerErr l blk) (l blk EmptyMK, Values blk)
foldLedger evs cfg =
