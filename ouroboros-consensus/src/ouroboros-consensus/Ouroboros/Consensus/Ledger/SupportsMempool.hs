...
type family InputTxDiffs blk wtd where
  ...
  InputTxDiffs blk Collect = TxsDiff blk
...
class
  ...
  applyTx ::
    ...
    Except (ApplyTxErr blk) (TickedLedgerState blk EmptyMK, TxsDiff blk, Validated (GenTx blk))
  ...
  reapplyTx ::
    ...
    Values blk ->
    TickedLedgerState blk EmptyMK ->
    Except (ApplyTxErr blk) (TickedLedgerState blk EmptyMK, TxsDiff blk)
