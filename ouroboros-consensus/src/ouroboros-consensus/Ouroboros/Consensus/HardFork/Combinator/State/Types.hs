...
newtype TranslateTxIn x y = TranslateTxIn {
    translateTxIn2 :: Key (LedgerState x) -> Key (LedgerState y)
  }

newtype TranslateTxOut x y = TranslateTxOut {
    translateTxOut2 :: Value (LedgerState x) -> Value (LedgerState y)
  }
