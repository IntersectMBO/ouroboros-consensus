...
deriving instance
  (All HasNetworkProtocolVersion xs, All (Compose Show WrapNodeToNodeVersion) xs) =>
  Show (HardForkNodeToNodeVersion xs)
deriving instance
  (All HasNetworkProtocolVersion xs, All (Compose Show EraNodeToClientVersion) xs) =>
  Show (HardForkNodeToClientVersion xs)

deriving instance
  (All HasNetworkProtocolVersion xs, All (Compose Eq WrapNodeToNodeVersion) xs) =>
  Eq (HardForkNodeToNodeVersion xs)
deriving instance
  (All HasNetworkProtocolVersion xs, All (Compose Eq EraNodeToClientVersion) xs) =>
  Eq (HardForkNodeToClientVersion xs)
...
instance
  ...
  HasNetworkProtocolVersion (HardForkBlock xs)
  where
