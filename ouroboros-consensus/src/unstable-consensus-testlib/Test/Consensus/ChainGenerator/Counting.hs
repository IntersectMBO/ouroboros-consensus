...
module Test.Consensus.ChainGenerator.Counting (
    -- * general counts
    Count (Count)
  , forgetBase
  , forgetElem
...
-- * @elem@ is the type-level name of the elements in the container (e.g. 'Test.Consensus.ChainGenerator.Slot.SlotE')
...
--
-- * @elem@ is a type-level name of the elements in the containing sequence (e.g. 'Test.Consensus.ChainGenerator.Slot.SlotE')
...
-- * @elem@ is a type-level name of the elements in the container (e.g. 'Test.Consensus.ChainGenerator.Slot.SlotE')
--
