...
instance
  ( SimpleCrypto c
  , Typeable ext
  , AChainDepStateSupportsPeras (ChainDepState (BlockProtocol (SimpleBlock c ext)))
  , AChainDepStateSupportsPeras (Ticked (ChainDepState (BlockProtocol (SimpleBlock c ext))))
  ) =>
