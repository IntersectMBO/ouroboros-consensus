...
- The reader is familir with the core architecture of the existing Praos implementation ([ChainSync](../../references/glossary.md#chainsync) mini protocol, [BlockFetch](../../references/glossary.md#blockfetch) mini protocol and decision logic, etc).
