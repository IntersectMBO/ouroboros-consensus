...
\newcommand{\headerHash}[1]{\fun{headerHash}~ \var{#1}}
\newcommand{\headerSize}[1]{\fun{headerSize}~ \var{#1}}
...
\newcommand{\hBPrevHeader}[1]{\fun{hBPrevHeader}~\var{#1}}
\newcommand{\hBBodyHash}[1]{\fun{hBBodyHash}~\var{#1}}
\newcommand{\hBVkCold}[1]{\fun{hBVkCold}~\var{#1}}
\newcommand{\bseedl}[1]{\fun{bseed}_{\ell}~\var{#1}}
\newcommand{\bprfn}[1]{\fun{bprf}_{n}~\var{#1}}
\newcommand{\bseedn}[1]{\fun{bseed}_{n}~\var{#1}}
\newcommand{\bprfl}[1]{\fun{bprf}_{\ell}~\var{#1}}
\newcommand{\hBOCert}[1]{\fun{hBOCert}~\var{#1}}
\newcommand{\bnonce}[1]{\fun{bnonce}~\var{#1}}
\newcommand{\bleader}[1]{\fun{bleader}~\var{#1}}
\newcommand{\hBBodySize}[1]{\fun{hBBodySize}~\var{#1}}
...
\newcommand{\ChainHeadState}{\type{ChainHeadState}}
...
\newcommand{\hBSlot}[1]{\fun{hBSlot}~\var{#1}}
\newcommand{\hBBlockNo}[1]{\fun{hBBlockNo}~\var{#1}}
\newcommand{\bbody}[1]{\fun{bbody}~\var{#1}}
\newcommand{\headerBody}[1]{\fun{headerBody}~\var{#1}}
